...
struct Cinfo {
  ...
  float start, end; // Coordinates for actual blending (only valid for the
...
template <typename PixelType> struct BlendingInfo {
  ...
  Cinfo core[4];  // Information about the length to process, flags, etc. 0:left
